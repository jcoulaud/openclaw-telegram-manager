...
An [OpenClaw](https://openclaw.ai) plugin that gives each Telegram topic its own persistent memory — so nothing gets lost when the AI resets or context gets compacted.
